...
export class IoTrustanchorQuickloginNS {
  ...
  login<A extends Auth = void>(
    cfg: MethodConfigOrHandler<
      A,
      IoTrustanchorQuickloginLogin.QueryParams,
      IoTrustanchorQuickloginLogin.HandlerInput,
      IoTrustanchorQuickloginLogin.HandlerOutput
    >,
  ) {
    const nsid = 'io.trustanchor.quicklogin.login' // @ts-ignore
    return this._server.xrpc.method(nsid, cfg)
  }
